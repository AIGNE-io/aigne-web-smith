...
For more information on other special components, please refer to the documentation on [Using Special Components](./advanced-features-use-special-components.md).
