...
Follow this guide when you want to reshape the sitemap with `aigne web generate`, such as adding or removing pages before approving the plan.
...
2.  **Review Proposed Structure**: After analyzing your sources, the terminal displays the proposed structure and asks for your input.
