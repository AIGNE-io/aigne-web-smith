...
使用本指南選擇正確的更新工作流程，然後深入閱讀詳細的子指南，以了解結構或頁面級別的變更。

網站生成後，您將不可避免地需要進行變更。AIGNE WebSmith 提供了一種清晰且結構化的方法來保持您的網站最新。更新通常分為兩類：修改網站的整體結構，或完善單個頁面內的內容。
