...
Use this guide to query `aigne web history`, interpret the log format, and filter or inspect individual updates.
...
-   [Updating Website Structure](./guides-update-website-update-structure.md)
