...
fs.input_schema = {
  ...
  properties: {
    action: {
      ...
      description:
        "The file system action to perform. Available actions: read_file, write_file, delete_file, list_directory.",
    },
    path: { type: "string", description: "The path to the file or directory to operate on" },
    content: {
      type: "string",
      description: "The content to write to the file (required for the write_file action).",
    },
  },
