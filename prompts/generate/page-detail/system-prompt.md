...
sections: # Required - page content blocks
  - sectionName: string # Required - section functional identifier, use camelCase naming
    ...
    componentName: string # Required - The component name to be used in this section, must exist in either <atomic_component_information> or <allowed_field_combinations> under the `name` field
