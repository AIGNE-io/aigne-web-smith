...
`;
  ...
  constraints += `- How to use components correctly:
    - Components with "Hero" in their name:
      ...
      - Can only appear as the first section of the page (index 0). Any Hero component in later sections will be rejected and must be replaced with a non-Hero alternative.
